...
workflow chip {
    ...
    output {
        ...
        Array[File?] nodup_bams = filter.nodup_bam
        Array[File?] out_fc_bw = macs2_signal_track.fc_bw
        Array[File?] out_pval_bw = macs2_signal_track.pval_bw
        Array[File?] out_peaks = call_peak.peak
        #Array[File?] out_overlap_peaks = overlap.overlap_peak
        File? out_idr_conservative_peaks = reproducibility_idr.conservative_peak
        File? out_idr_optimal_peaks = reproducibility_idr.optimal_peak
    }
}
