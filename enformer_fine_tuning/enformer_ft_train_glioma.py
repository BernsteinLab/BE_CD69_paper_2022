...
## custom modules
import enformer_nomod_glioma as enformer
...
def main():
    ...
    def sweep_train(config_defaults=None):
        ...
        with strategy.scope():
            ...
            tr_data,val_data = training_utils.return_distributed_iterators(args.gcs_path,
                                 GLOBAL_BATCH_SIZE,
                                 196608,
                                 10,
                                 1536,
            ...
            for epoch_i in range(1, wandb.config.num_epochs+1):
                ...
                print(pearsonsR)
                wandb.log({'OPC_h3k27ac': pearsonsR[0],
                           'NPC_h3k27ac': pearsonsR[1],
                           'OPC_atac': pearsonsR[2]},
                          step=epoch_i)
